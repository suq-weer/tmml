...
import {
    create_game_profile, delete_game_profile, set_default_profile, useProfileStore,
} from '../libs/profile';
...
<template>
    <div class="profiles-page">
        <header class="page-head">
            <h2>游戏档案管理</h2>
            <p class="page-desc">管理准备在游戏里启动的玩家账号。当前支持离线登录，其它登录方式开发中。</p>
        </header>

        <mdui-card variant="outlined" class="card">
            <div class="card-title">新建离线档案</div>
            <div class="create-row">
                <mdui-text-field label="玩家名" :value="username" @input="username = ($event.target as any).value"></mdui-text-field>
